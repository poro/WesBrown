...
import {ApiModelContext} from "@/components/modals/apimodelcontext";
import {z} from "zod";
...
const AiModelModal = () => {
    ...
    function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        toast({
            title: "Updated",
            description: "Your OpenAI API Model has been modified to " + data['aiModel'] + ".",
            variant: "success",
        })
        onClose();
    }
    ...
    return (
        <ApiModelContext.Provider value={{ apiModel, setApiModel }}>
